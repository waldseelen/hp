...
class LighthouseRunner:
    ...
    def extract_metrics(self, report_file):
        ...
        try:
            ...
            metrics = {
                ...
                'network_requests': audits.get('network-requests', {}).get('numericValue', 0),
            }
    ...
    def generate_report(self, results, output_file='performance-summary.json'):
        ...
        # Metrics to average
        metrics_to_average = [
            'performance_score', 'first_contentful_paint', 'largest_contentful_paint',
            'first_input_delay', 'cumulative_layout_shift', 'time_to_interactive',
            'speed_index', 'total_blocking_time', 'total_byte_weight', 'network_requests'
        ]
...
def main():
    ...
    try:
        subprocess.run(['npx', 'lighthouse', '--version'],
