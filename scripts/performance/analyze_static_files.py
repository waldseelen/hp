...
class StaticFilesAnalyzer:
    ...
    def generate_report(self, file_sizes, ext_stats):
        ...
        for ext, data in ext_stats.items():
            report['by_extension'][ext] = {
                ...
                'average_size_kb': round((data['total_size'] / data['count']) / 1024, 2) if data['count'] > 0 else 0,
    ...
    def print_summary(self, report):
        ...
        print(f"  Total Size: {summary['total_size_mb']:.2f} MB ({summary['total_size_kb']:.0f} KB)")
        print()
