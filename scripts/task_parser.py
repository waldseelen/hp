...
class TaskProtocolParser:
    ...
    def validate_structure(self) -> List[str]:
        ...
        required_keys = ['title', 'identity_and_purpose', 'roadmap_source', 'workflow_loop', 'interaction_rules', 'protocol_initiation']
        ...
        if 'workflow_loop' in self.data:
            ...
            if 'steps' not in workflow:
                ...
                if set(actual_steps) != set(expected_steps):
                    issues.append(f"Expected steps {expected_steps}, found {actual_steps}")
