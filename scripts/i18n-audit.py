...
class I18nAuditor:
    ...
    def _generate_recommendations(self):
        ...
        if self.issues['hardcoded_strings']:
            recommendations.append({
                ...
                'files_affected': len(set(item['file'] for item in self.issues['hardcoded_strings']))
            })
    ...
    def _generate_readable_report(self, report):
        ...
        with open(report_md, 'w', encoding='utf-8') as f:
            ...
            f.write(f"- **JS Translations Needed**: {summary['js_translations_needed']}\n")
            f.write(f"- **PO File Issues**: {summary['po_file_issues']}\n")
            f.write(f"- **Missing Translations**: {summary['missing_translations']}\n\n")
