...
class PostAdmin(admin.ModelAdmin):
    list_display = ('title', 'author', 'status', 'status_display', 'view_count', 'reading_time', 'published_at', 'created_at')
    ...
    readonly_fields = ('created_at', 'updated_at', 'view_count', 'reading_time_display', 'image_preview')
    ...
    def image_preview(self, obj):
        if obj.featured_image:
            ...
            return format_html('<img src="{}" style="max-height: 100px; max-width: 200px;" />', obj.featured_image_url)
        return "No image"
