...
class ToolAdmin(admin.ModelAdmin):
    list_display = ('title', 'category', 'rating_display', 'pricing', 'is_favorite', 'is_visible', 'created_at')
    ...
    fieldsets = (
        ...
        ('Değerlendirme & Etiketler', {
            'fields': ('rating', 'pricing', 'tags')
        }),
        ('Favoriler & Görünürlük', {
            'fields': ('is_favorite', 'is_visible')
        }),
        ('Güncelleme Bilgisi', {
            'fields': ('last_updated',),
            'classes': ('collapse',),
