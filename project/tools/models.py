...
class Tool(models.Model):
    ...
    title = models.CharField(
        max_length=200,
        help_text="Name of the tool or resource"
    )
    description = models.TextField(
        help_text="Detailed description of what this tool does"
    )
    url = models.URLField(
        help_text="Official URL or link to the tool"
    )
    ...
    tags = models.JSONField(
        blank=True,
        null=True,
        help_text="List of tags for this tool (as JSON array)"
    )
    is_favorite = models.BooleanField(
        default=False,
        help_text="Mark as favorite tool (will appear on home page)"
    )
    is_visible = models.BooleanField(
        default=True,
        help_text="Whether this tool is visible on the site"
    )
    icon_url = models.URLField(
        blank=True,
        null=True,
        help_text="URL to an icon/logo for this tool"
    )
    ...
    rating = models.PositiveSmallIntegerField(
        blank=True,
        null=True,
        help_text="Personal rating from 1-5 stars"
    )
    last_updated = models.DateField(
        blank=True,
        null=True,
        help_text="When this tool info was last updated"
    )
    ...
    def get_similar_tools(self, limit=3):
        ...
        similar = Tool.objects.visible().filter(
    ...
    def __str__(self):
        ...
        return f"{self.title} {category_indicator}{favorite_indicator}{visible_indicator}"
