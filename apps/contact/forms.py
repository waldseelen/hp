...
class ContactForm(forms.ModelForm):
    ...
    def clean_subject(self):
        ...
        for pattern in spam_patterns:
            if re.search(pattern, subject.lower()):
                raise ValidationError('Subject contains content that appears to be spam.')
    ...
    def clean_message(self):
        ...
        if len(url_matches) > 2:
            raise ValidationError('Message contains too many URLs. Please limit to 2 URLs maximum.')
