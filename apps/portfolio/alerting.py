...
class AlertManager:
    ...
    def create_alert(self, alert_type, metric_name, current_value, threshold=None, metadata=None):
        """
    ...
    def check_metric_thresholds(self, metric_type, value, baseline=None):
        ...
        try:
            ...
            if value > threshold * 1.5:
                if self.create_alert('performance_degradation', metric_type, value, threshold * 1.5):
                    alerts_triggered.append('performance_degradation')
            
            # Check critical threshold (2x normal)
            if value > threshold * 2:
                if self.create_alert('critical_performance', metric_type, value, threshold * 2):
