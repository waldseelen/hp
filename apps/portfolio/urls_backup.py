...
urlpatterns = [
    ...
    path(
        "api/performance/",
        views.collect_performance_metric,
        name="api_performance_collect",
    ),
    path(
        "api/performance/summary/",
        views.performance_summary,
        name="api_performance_summary",
    ),
    path(
        "api/performance/dashboard/",
        views.performance_dashboard_data,
    ...
    path(
        ...
        name="api_webpush_subscribe",
    ),
    path(
        "api/webpush/unsubscribe/",
        views.webpush_unsubscribe,
        name="api_webpush_unsubscribe",
    ),
    ...
    path(
        "api/personal-info/",
        views.PersonalInfoListAPIView.as_view(),
        name="api_personal_info",
    ),
    path(
        "api/social-links/",
        views.SocialLinkListAPIView.as_view(),
        name="api_social_links",
    ),
    path("api/ai-tools/", views.AIToolListAPIView.as_view(), name="api_ai_tools"),
    path(
        "api/cybersecurity/",
        views.CybersecurityResourceListAPIView.as_view(),
        name="api_cybersecurity",
    ),
    path(
        "api/useful-resources/",
        views.UsefulResourceListAPIView.as_view(),
        name="api_useful_resources",
    ),
