...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            '--task',
            type=str,
            choices=['all', 'notification', 'user_action', 'analytics', 'cleanup', 'health'],
            default='all',
    ...
    def test_notification_task(self):
        ...
        try:
            ...
            try:
                ...
                self.stdout.write(
                    self.style.ERROR(f'✗ Notification task failed: {e}')
                )
    ...
    def test_user_action_task(self):
        ...
        try:
            ...
            try:
                ...
                self.stdout.write(
                    self.style.ERROR(f'✗ User action task failed: {e}')
                )
    ...
    def test_analytics_task(self):
        ...
        try:
            ...
            try:
                ...
                self.stdout.write(
                    self.style.ERROR(f'✗ Analytics task failed: {e}')
                )

        except Exception as e:
            self.stdout.write(
                self.style.ERROR(f'✗ Error testing analytics task: {e}')
            )
    ...
    def test_cleanup_task(self):
        ...
        try:
            ...
            try:
                ...
                self.stdout.write(
                    self.style.ERROR(f'✗ Cleanup task failed: {e}')
                )

        except Exception as e:
            self.stdout.write(
                self.style.ERROR(f'✗ Error testing cleanup task: {e}')
            )
    ...
    def test_retry_logic(self):
        ...
        try:
            ...
            try:
                ...
                self.stdout.write(
                    self.style.SUCCESS(f'✓ Retry logic working - task failed as expected: {e}')
                )

        except Exception as e:
            self.stdout.write(
                self.style.ERROR(f'✗ Error testing retry logic: {e}')
            )