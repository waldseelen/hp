...
from apps.main.models import PersonalInfo, SocialLink, AITool, CybersecurityResource, MusicPlaylist
...
class SecurityHeadersMiddlewareTest(TestCase):
    ...
    def test_production_security_headers(self):
        ...
        response = self.client.get('/', SERVER_NAME='testserver', wsgi={'wsgi.url_scheme': 'https'})
...
class MainViewsTest(TestCase):
    ...
    def test_view_caching(self):
        ...
        self.assertEqual(len(response1.context['personal_info']), len(response2.context['personal_info']))
