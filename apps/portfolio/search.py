...
from apps.portfolio.search.formatters.base_formatter import SearchResultFormatter
from apps.portfolio.search.scorers.relevance_scorer import RelevanceScorer
