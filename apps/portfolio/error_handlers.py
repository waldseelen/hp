...
def safe_render(request, template_name: str, context: Dict[str, Any] = None, fallback_template: str = None):
    ...
    def send_alert(error_data: Dict[str, Any]):
        ...
        try:
            ...
            if hasattr(settings, 'ADMINS') and settings.ADMINS:
                subject = f"Error Alert: {error_data.get('error_type', 'Unknown Error')}"
                message = f"""
