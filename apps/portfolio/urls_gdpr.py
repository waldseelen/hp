...
urlpatterns = [
    ...
    path('cookie-consent/status/', gdpr_views.cookie_consent_status, name='cookie_consent_status'),

    # Data Export
    path('data-export/', gdpr_views.request_data_export, name='data_export'),

    # Account Deletion
    path('account-deletion/', gdpr_views.request_account_deletion, name='account_deletion'),
