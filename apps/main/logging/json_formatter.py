...
class StructuredJSONFormatter(logging.Formatter):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.service_name = kwargs.pop('service_name', getattr(settings, 'SERVICE_NAME', 'portfolio_site'))
        self.environment = kwargs.pop('environment', getattr(settings, 'ENVIRONMENT', 'development'))
    ...
    def _get_django_context(self, record: logging.LogRecord) -> Optional[Dict[str, Any]]:
            ...
            if isinstance(request_data, dict):
                ...
                try:
                    context['request'] = {
                        ...
                        'remote_addr': request_data.META.get('REMOTE_ADDR') if hasattr(request_data, 'META') else None,
                    }
                except:
                    pass
    ...
    def _get_performance_data(self, record: logging.LogRecord) -> Optional[Dict[str, Any]]:
    ...
    def _get_security_context(self, record: logging.LogRecord) -> Optional[Dict[str, Any]]:
...
class SecurityFilter(logging.Filter):
    ...
    SECURITY_KEYWORDS = [
        'authentication', 'authorization', 'login', 'logout', 'permission',
        'csrf', 'xss', 'sql injection', 'brute force', 'unauthorized',
        'forbidden', 'access denied', 'security', 'breach', 'intrusion'
    ]
