...
from .fixtures.portfolio_fixtures import PortfolioFixtures
import logging
...
def home(request):
    ...
    fallback_personal_info = [
        {
            'key': 'bio',
            'type': 'text',
            'value': _('Building secure, human-centered products with a decade of full stack experience across Python, Django, React, and cloud native tooling.')
        },
        {
            'key': 'about',
            'type': 'text',
            'value': _('I help teams launch resilient platforms, harden security posture, and ship delightful experiences faster.')
        },
    ]

    fallback_social_links = [
        {'platform': 'github', 'url': 'https://github.com/bugraakin', 'description': _('GitHub profile')},
        {'platform': 'linkedin', 'url': 'https://linkedin.com/in/bugraak', 'description': _('LinkedIn profile')},
        {'platform': 'cal', 'url': 'https://cal.com/bugraakin', 'description': _('Book a call')}
    ]

    fallback_posts = [
        SimpleNamespace(
            title=_('Designing secure platforms without slowing release velocity'),
            excerpt=_('How a blended DevSecOps model reduced incident response time by 40% while shipping weekly releases.'),
            read_time=6,
        ...
        SimpleNamespace(
            ...
            excerpt=_('Telemetry patterns that surface real user impact before it hits the roadmap.'),
            read_time=5,
        ...
        SimpleNamespace(
            ...
            excerpt=_('Lessons from leading multi-brand component libraries serving millions.'),
            read_time=7,
    ...
    fallback_tools = [
        SimpleNamespace(
            name='Telemetry Deck',
            description=_('Real-time observability dashboards that protect user privacy by design.'),
        ...
        SimpleNamespace(
            name='Linear',
            description=_('Product delivery OS for roadmaps, async rituals, and focused execution.'),
        ...
        SimpleNamespace(
            name='ThreatMapper',
            description=_('Cloud native attack surface mapping to keep workloads hardened.'),
    ...
    fallback_ai_tools = [
        SimpleNamespace(
            name='PromptLayer',
            description=_('Audit and version AI prompts across teams with reproducible workflows.'),
            url='https://promptlayer.com',
            category_label=_('AI Workflow')
        ),
        SimpleNamespace(
            name='LangFuse',
            description=_('Tracing, evaluation, and analytics for LLM-powered features.'),
    ...
    fallback_security = [
        SimpleNamespace(
            ...
            summary=_('Two-week red-team style reviews that surface critical gaps before launch.'),
        ...
        SimpleNamespace(
            ...
            summary=_('Model card auditing, prompt review, and vendor risk scoring for compliant releases.'),
    ...
    try:
        ...
        fallback_posts = [
            SimpleNamespace(
                title=_('Designing secure platforms without slowing release velocity'),
                excerpt=_('How a blended DevSecOps model reduced incident response time by 40% while shipping weekly.'),
                read_time=6,
                link='https://cal.com/bugraakin',
                published_at=timezone.now()
            ),
        ...
        fallback_tools = [
            SimpleNamespace(
                name='Telemetry Deck',
                description=_('Serverless analytics that surfaces actionable insight without storing personal data.'),
                url='https://telemetrydeck.com',
                tags=[_('Observability'), _('Realtime')],
                category_label=_('Ops & Monitoring'),
                rating=5
            ...
            SimpleNamespace(
                name='Linear',
                description=_('Product delivery OS we rely on for engineering rituals, roadmaps, and async collaboration.'),
                url='https://linear.app',
                tags=[_('Product Ops'), _('Planning')],
                category_label=_('Product Delivery'),
                rating=5
            ...
            SimpleNamespace(
                name='ThreatMapper',
                description=_('Cloud native threat mapping to keep workloads hardened in dynamic environments.'),
                url='https://github.com/deepfence/ThreatMapper',
                tags=[_('Security'), _('Cloud')],
                category_label=_('Security Toolkit'),
                rating=4
