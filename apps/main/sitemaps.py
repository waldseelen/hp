...
from .models import UsefulResource, AITool, CybersecurityResource
...
class ResourceSitemap(Sitemap):
    ...
    def items(self):
        ...
        # Add AI tools
        ai_tools = AITool.objects.all().order_by('-updated_at')[:100]  # Limit for performance
        ...
        useful_resources = UsefulResource.objects.filter(
            is_visible=True
        ).order_by('-updated_at')[:100]
