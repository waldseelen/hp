...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        languages = [
            {'name': 'Python', 'icon': 'PY', 'tagline': 'AI Programming', 'extension': 'py', 'order': 1},
            {'name': 'JavaScript', 'icon': 'JS', 'tagline': 'Web Development', 'extension': 'js', 'order': 2},
            {'name': 'C', 'icon': 'C', 'tagline': 'System Programming', 'extension': 'c', 'order': 3},
            {'name': 'C++', 'icon': 'C++', 'tagline': 'Game Development', 'extension': 'cpp', 'order': 4},
            {'name': 'C#', 'icon': 'C#', 'tagline': 'Enterprise Apps', 'extension': 'cs', 'order': 5}
        ]
