...
class Post(models.Model):
    ...
    featured_image_url = models.URLField(
        blank=True,
        null=True,
        help_text="URL to a featured image for this post"
    )
    ...
    tags = models.JSONField(
        blank=True,
        null=True,
        help_text="List of tags for this post (as JSON array)"
    )
    ...
    published_at = models.DateTimeField(
        blank=True,
        null=True,
        help_text="When this post was/will be published"
    )
    ...
    def clean(self):
        ...
        if self.status in ['published', 'scheduled'] and not self.content:
            raise ValidationError({'content': 'Content is required for published posts'})
